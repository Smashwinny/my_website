...
以站主提供的 `sample.jpg` / `sample.mp4` 为暗色手部能量视觉参考，以 `sample2.jpg` 人物为主体生成专属托球画面。主体是优化后的静态 WebP（当前绿色巨人造型约 81 KB），元素球由 Canvas 实时绘制：火焰与火星、水纹与水滴、电弧与辉光。不是原视频播放或新的 VRM 人物。
...
掌中万象主体已更新为保留原人物面貌、眼镜的绿色巨人造型，采用强烈明暗对比和更阴暗的神态。当前资源为 `hero-titan-face.webp`，掌心球体位置随新画面对齐；原 `hero.webp` 留作版本回退。

人物脸部恢复为此前自然面貌与眼镜，头发加密、发际线略降低；绿色巨人的身体、衣甲与托球构图继续保留。

...
const worlds:Record<WorldStyle,ComponentType<WorldProps>>={garden:lazy(()=>import('./world')),mist:lazy(()=>import('./mist-world')),elements:lazy(()=>import('./element-world')),mario:lazy(()=>import('./mario-world')),monument:lazy(()=>import('./monument-world'))};
